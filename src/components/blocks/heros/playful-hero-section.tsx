...
// Removed RoughNotation imports due to package conflict
    ...
    <div ref={ref} className="mb-20 w-full bg-gray-50 dark:bg-neutral-800">
      <div className="mx-auto grid max-h-[50rem] max-w-7xl grid-cols-1 items-start gap-10 overflow-hidden pt-10 sm:grid-cols-2 md:max-h-[40rem] md:pt-20 lg:grid-cols-3">
        <div className="px-4 py-10 md:px-8 md:py-10 lg:col-span-2">
          ...
          >
            Your favourite <span className="text-currentColor font-bold">productivity tool</span> is now available for <span className="underline text-yellow-500">mobile</span>
          </h2>
          <p className="mt-4 max-w-2xl text-center text-sm text-neutral-500 sm:text-left md:mt-10 md:text-lg dark:text-neutral-400">
            Aceternity AI bring you the best productivity tools for your desktop, now available on mobile. Download the app now to avail additional <span className="underline text-yellow-500">20% discount</span> and take your productivity to the next level.
          </p>
