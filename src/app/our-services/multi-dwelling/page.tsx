        ...
        <section className="bg-gradient-to-br from-gray-50 to-gray-100 py-24">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-[1200px] text-center">
            <div className="flex justify-center mb-6">
              <Users className="w-16 h-16 text-primary-dark" />
            </div>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-primary-dark mb-6">
              Multi Dwelling
            </h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Develop premium multi-dwelling projects for investment or sale. From dual residences to townhouse developments, we create profitable properties designed for modern urban living.
            </p>
          </div>
        </section>
