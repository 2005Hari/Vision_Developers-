        ...
        <section className="bg-gradient-to-br from-gray-50 to-gray-100 py-24">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-[1200px] text-center">
            <div className="flex justify-center mb-6">
              <MapPin className="w-16 h-16 text-primary-dark" />
            </div>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-primary-dark mb-6">
              Sub Divisions
            </h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Maximize your property's potential with professional subdivision expertise. We handle everything from initial assessment to council approvals, creating additional lots for sale or investment.
            </p>
          </div>
        </section>
